...
fig_b1 = canvas(560, 160,
    ...
    text(150, 130, "두 길 다 된다: 변수분리 du/(u−1) = −3dx/x  /  선형 공식 h = 3 ln x", 12, GRAY, "middle"),
...
fig_super = canvas(560, 200,
    ...
    arrow(60, 170, 390, 40, GREEN, "", 3), text(250, 96, "c₁y₁ + c₂y₂", 14, GREEN, "middle", True),
...
fig_indep = canvas(560, 190,
    ...
    text(260, 40, "y₁ = eˣ", 13, BLUE, "start", True), text(70, 40, "y₂ = e⁻ˣ", 13, RED, "start", True),

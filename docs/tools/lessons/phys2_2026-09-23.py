...
fig_cyl = canvas(560, 220,
    line(90, 60, 470, 60, INK, 3), line(90, 160, 470, 160, INK, 3), text(480, 66, "바깥 도체 (반지름 b)", 12, INK), text(480, 166, "", 1),
    rect(90, 102, 380, 16, RED, fill="rgba(224,49,49,.25)", sw=1.5), text(480, 116, "안쪽 도체 a, +q", 12, RED),
...
fig_diel = canvas(560, 220,
    plate(140, 40, 280, 16, "+", 9), plate(140, 164, 280, 16, "−", 9),
    rect(140, 70, 280, 80, YEL, fill="rgba(245,159,0,.10)", sw=1.5), text(430, 112, "유전체(종이)", 12, "#B26A00"),
    text(280, 82, "− − − − − − − −  (−q′ 유도)", 12, BLUE, "middle"), text(280, 144, "+ + + + + + + +  (+q′ 유도)", 12, RED, "middle"),
    arrow(200, 60, 200, 160, GREEN, "E₀ (판의 전하)", 2.2, -40, 0), arrow(360, 140, 360, 90, BLUE, "E′ (유도 전하, 반대)", 2.2, 44, 0),

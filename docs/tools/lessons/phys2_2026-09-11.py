...
fig_ring = canvas(560, 250,
    ...
    dot(160, 190, "", 5, RED), text(150, 214, "dq", 12, RED, "middle"), dot(400, 190, "", 5, RED), text(410, 214, "dq (반대편)", 12, RED, "middle"),
...
fig_disk = canvas(560, 240,
    ...
    text(280, 232, "반지름 R 원판 (면밀도 σ) — 반지름 r, 폭 dr 인 고리 띠를 0~R까지 쌓는다", 12.5, INK, "middle"),
    ...
    arrow(280, 40, 280, 6, GREEN, "dE_z", 2.4, 22, 0),
    text(360, 190, "dq = σ·2πr dr", 12.5, RED),
...
fig_plane = canvas(560, 170,
    ...
    path("M60 60 C 200 62, 320 110, 520 125", RED, 2.5, dash="6 4"), text(430, 105, "유한 원판: 멀어지면 줄어든다", 12, RED, "middle"),
    cap="원판 결과에서 \\(R\\to\\infty\\)이면 둘째 항이 0 → 어디서 재도 같은 \\(\\sigma/2\\varepsilon_0\\).")

fig_gauss = canvas(560, 220,
    circle(150, 110, 70, PINK, dash="7 5", w=2.5), text(150, 205, "가우스면(가상의 폐곡면)", 12.5, PINK, "middle"),
    charge(150, 110, "+", "", 14, RED), text(150, 140, "+1 C", 12, RED, "middle"),
    radial(150, 110, 8, 22, 100, GREEN),
    rect(196, 82, 18, 18, INK, fill="rgba(255,255,255,.6)", sw=1.5), text(224, 76, "da (미소면적)", 12, INK),
